    ...
    <div class="login-wrapper ">
      ...
      <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          <h2><b>eLIBRARY</b></h2>
          <span><b>You have successfully logged out.</b></span>
          <p class="p-t-35">Do you want to sign up or log into your account?</p>
            <button class="btn btn-primary btn-cons m-t-10 log_in" type="submit" onClick="location.href='signup.php'">Sign Up</button>
            <button class="btn btn-primary btn-cons m-t-10 log_in" type="submit" onClick="location.href='login.php'">Login</button>
        </div>
      </div>
